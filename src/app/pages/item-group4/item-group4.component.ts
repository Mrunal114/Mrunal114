...
@Component({
  ...
  templateUrl: './item-group4.component.html',
  styleUrl: './item-group4.component.css'
})
export class ItemGroup4Component {
  ...
  selectedStatus = '';
  formFields = [
    { type: 'inputfield', label: 'Item Group 4', placeholder: 'Enter Item Group 4', value: '' },
  ...
  openPopup() {
    this.popupModal.title = 'Item Group4 Management';
