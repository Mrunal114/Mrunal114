...
@Component({
  ...
  templateUrl: './Customer-Group-2.component.html',
  styleUrl: './Customer-Group-2.component.css'
})
export class CustomerGroup2Component {
  ...
  selectedStatus = '';
  formFields = [
    { type: 'inputfield', label: 'Customer Group-2', placeholder: 'Search by Customer Group-2', value: '' },
  ...
  openPopup() {
    this.popupModal.title = 'Customer Group-2 Management';
